...
- Compatible with the [Dice So Nice!](https://foundryvtt.com/packages/dice-so-nice/) module. Holds the sound effect until the rolling animation is completed.
...
- Adding effects for min / max damage.